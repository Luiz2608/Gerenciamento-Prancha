        ...
        if (it.table === "motoristas") {
          ...
          if (it.op === "insert") {
            ...
            try {
              ...
              row = await processInsert("pranchas", payload2);
            }
            const oldId = it.localId;
