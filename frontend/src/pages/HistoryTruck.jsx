...
import { getMotoristas, getCaminhoes, getViagemByCaminhao } from "../services/storageService.js";
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer } from "recharts";

export default function HistoryTruck() {
  ...
  const load = async () => {
    ...
    setDrivers(d);
    setTrucks(t.filter((x) => x.status === "Ativo"));
  };
  const query = async () => {
