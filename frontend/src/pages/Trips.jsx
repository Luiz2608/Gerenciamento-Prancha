...
export default function Trips() {
  ...
  const [form, setForm] = useState({ date: "", driver_id: "", truck_id: "", prancha_id: "", destination: "", service_type: "", description: "", start_time: "", end_time: "", km_start: "", km_end: "", fuel_liters: "", fuel_price: "", other_costs: "" });
  ...
  const submit = async (e) => {
    ...
    setForm({ date: "", driver_id: "", truck_id: "", prancha_id: "", destination: "", service_type: "", description: "", start_time: "", end_time: "", km_start: "", km_end: "", fuel_liters: "", fuel_price: "", other_costs: "" });
    setEditing(null);
    loadTrips();
  };
    ...
    <div className="space-y-8">
      <div className="card p-6 animate-fade">
        ...
        <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <select className="select" value={form.truck_id} onChange={(e) => setForm({ ...form, truck_id: e.target.value })}>
            <option value="">Caminhão</option>
            {trucks.map((t) => <option key={t.id} value={t.id}>{t.plate || t.model || t.id}</option>)}
          </select>
          <select className="select" value={form.prancha_id} onChange={(e) => setForm({ ...form, prancha_id: e.target.value })}>
